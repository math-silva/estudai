...
const OptionBox = ({title, icon, link}: OptionBoxProps) => {
  return (
    <>
    <Link href={link} className="cursor-pointer p-4 lg:py-6 w-64 rounded-2xl flex flex-col gap-4 lg:gap-6 items-center border border-white bg-white bg-opacity-5 hover:bg-opacity-15">
